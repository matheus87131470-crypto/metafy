...
async function loadTopPicks() {
  ...
  try {
    ...
    const staticPicks = [
      // 1 — Fiorentina vs Pisa: casa favorita mas edge negativo → Média (sem grande valor)
      {
        id: 's-1', league: 'SERIE A', time: '14:30',
        home: 'Fiorentina', away: 'Pisa',
        market: 'Resultado', pick: 'Vitória Casa',
        confidencePct: '72.0', confidenceLevel: 'MÉDIA CONFIANÇA', levelClass: 'medium',
        rating: 'Moderada', statusGroup: 'upcoming',
        bestPick: 'home', bestPickLabel: 'Vitória Casa', edge: -3, probAdjusted: 48, probImplied: 51,
        explanation: 'Fiorentina é tecnicamente superior, mas as odds já precificam essa vantagem — edge ligeiramente negativo. Apostar com cautela.',
        keyStats: [
          'Prob ajustada casa: 48% vs implícita: 51% (odd ~1.95)',
          'Fiorentina: melhor qualidade técnica e mandante',
          'Edge: -3% — sem valor forte; stake conservadora',
        ],
        iaFree: true,
      },
      // 2 — Bologna vs Udinese: empate melhor opção
      {
        id: 's-2', league: 'SERIE A', time: '16:45',
        home: 'Bologna', away: 'Udinese',
        market: 'Resultado', pick: 'Empate',
        confidencePct: '69.0', confidenceLevel: 'LEVE VALOR', levelClass: 'medium',
        rating: 'Leve', statusGroup: 'upcoming',
        bestPick: 'draw', bestPickLabel: 'Empate', edge: -3, probAdjusted: 42, probImplied: 45,
        explanation: 'Times equilibrados. Casa levemente favorita pelo mercado, mas modelo ajustado aponta empate como cenário mais provável.',
        keyStats: [
          'Prob ajustada casa: 42% | empate: 30% | fora: 28%',
          'Bologna e Udinese: desempenho similar, baixa média de gols',
          'Empate: melhor opção mesmo sem edge positivo',
        ],
        iaFree: true,
      },
      // 3 — Everton vs Man Utd: visitante com edge positivo
      {
        ...
        rating: 'Leve', statusGroup: 'upcoming',
        bestPick: 'away', bestPickLabel: 'Vitória Fora', edge: 2, probAdjusted: 37, probImplied: 35,
        explanation: 'Manchester United com edge leve de +2%. Superioridade técnica e melhor momento recente sustentam a direção visitante.',
        keyStats: [
          'Prob ajustada visitante: 37% vs implícita: 35%',
          'United: melhor forma recente e elenco superior',
          'Edge: +2% — valor leve; stake conservadora',
        ],
        iaFree: false,
      },
      // 4 — Alaves vs Girona: visitante forte com edge médio
      {
        id: 's-4', league: 'LA LIGA', time: '16:00',
        home: 'Alavés', away: 'Girona',
        market: 'Resultado', pick: 'Vitória Fora',
        confidencePct: '76.0', confidenceLevel: 'MÉDIA CONFIANÇA', levelClass: 'medium',
        rating: 'Moderada', statusGroup: 'upcoming',
        bestPick: 'away', bestPickLabel: 'Vitória Fora', edge: 4, probAdjusted: 42, probImplied: 38,
        explanation: 'Girona com edge de +4%. Melhor eficiência ofensiva e desempenho sólido fora de casa sustentam a vitória visitante.',
        keyStats: [
          'Prob ajustada visitante: 42% vs implícita: 38%',
          'Girona: melhor qualidade técnica e consistência fora',
          'Edge: +4% — valor moderado',
        ],
        iaFree: false,
      },
      // 5 — Sweden U17 vs Poland U17: sem valor claro
      {
        id: 's-5', league: 'SUB-17 INTERNACIONAL', time: '13:00',
        home: 'Sweden U17', away: 'Poland U17',
        market: 'Resultado', pick: '—',
        confidencePct: '55.0', confidenceLevel: 'SEM APOSTA', levelClass: 'low',
        rating: 'Alto risco', statusGroup: 'upcoming',
        bestPick: 'home', bestPickLabel: '—', edge: 0, probAdjusted: 36, probImplied: 36,
        explanation: 'Base juvenil com alta instabilidade estatística. Probabilidades distribuídas de forma quase uniforme — nenhum mercado apresenta edge confiável.',
        keyStats: [
          'Casa: 36% | Empate: 32% | Fora: 32% — distribuição quase uniforme',
          'Jovens: desempenho muito instável para modelagem confiável',
          'Recomendação: evitar aposta nesta partida',
        ],
        iaFree: false,
      },
      // 6 — Al Ain U23 vs Bani Yas U23: casa moderada
      {
        id: 's-6', league: 'UAE U23', time: '15:00',
        home: 'Al Ain U23', away: 'Bani Yas U23',
        market: 'Resultado', pick: 'Vitória Casa',
        confidencePct: '74.0', confidenceLevel: 'MÉDIA CONFIANÇA', levelClass: 'medium',
        rating: 'Moderada', statusGroup: 'upcoming',
        bestPick: 'home', bestPickLabel: 'Vitória Casa', edge: 3, probAdjusted: 55, probImplied: 52,
        explanation: 'Al Ain U23 leva vantagem em casa e apresenta maior qualidade técnica. Edge de +3% sustenta a direção.',
        keyStats: [
          'Prob ajustada casa: 55% vs implícita: 52%',
          'Al Ain U23: dominância técnica no mando',
          'Edge: +3%',
        ],
        iaFree: false,
      },
      // 7 — Khorfakkan U23 vs Al Nasr U23: empate leve
      {
        id: 's-7', league: 'UAE U23', time: '15:00',
        home: 'Khorfakkan U23', away: 'Al Nasr U23',
        market: 'Resultado', pick: 'Empate',
        confidencePct: '68.0', confidenceLevel: 'LEVE VALOR', levelClass: 'medium',
        rating: 'Leve', statusGroup: 'upcoming',
        bestPick: 'draw', bestPickLabel: 'Empate', edge: 1, probAdjusted: 31, probImplied: 30,
        explanation: 'Equipes equilibradas em nível sub-23. Empate emerge como melhor opção com distribuição de probabilidades uniforme.',
        keyStats: [
          'Casa: 38% | Empate: 31% | Fora: 31%',
          'Nível técnico similar entre os dois lados',
          'Edge leve — stake reduzida',
        ],
        iaFree: false,
      },
      // 8 — Brondby vs Sonderjyske: casa com alta confiança
      {
        id: 's-8', league: 'DINAMARCA', time: '14:00',
        home: 'Brøndby', away: 'Sønderjyske',
        market: 'Resultado', pick: 'Vitória Casa',
        confidencePct: '87.0', confidenceLevel: 'ALTA CONFIANÇA', levelClass: 'high',
        rating: 'Forte', statusGroup: 'upcoming',
        bestPick: 'home', bestPickLabel: 'Vitória Casa', edge: 5, probAdjusted: 58, probImplied: 53,
        explanation: 'Brøndby com edge real de +5%. Forte desempenho em casa e superioridade técnica clara sobre adversário da divisão inferior.',
        keyStats: [
          'Prob ajustada casa: 58% vs implícita: 53%',
          'Brøndby: dominância histórica no confronto',
          'Edge: +5% — melhor relação risco/retorno da lista',
        ],
        iaFree: false,
      },
      // 9 — Lechia Gdansk vs Zaglebie Lubin: casa leve
      {
        id: 's-9', league: 'EXTRAKLASA', time: '14:00',
        home: 'Lechia Gdańsk', away: 'Zagłębie Lubin',
        market: 'Resultado', pick: 'Vitória Casa',
        confidencePct: '70.0', confidenceLevel: 'LEVE VALOR', levelClass: 'medium',
        rating: 'Leve', statusGroup: 'upcoming',
        bestPick: 'home', bestPickLabel: 'Vitória Casa', edge: 1, probAdjusted: 41, probImplied: 40,
        explanation: 'Lechia com leve vantagem em casa. Edge marginal de +1% — partida equilibrada, apostar com stake baixa.',
        keyStats: [
          'Prob ajustada casa: 41% | empate: 30% | fora: 29%',
          'Lechia: mando de campo como diferencial',
          'Edge: +1% — valor marginal',
        ],
        iaFree: false,
      },
      // 10 — FCSB vs Metaloglobus: casa forte
      {
        id: 's-10', league: 'LIGA I (ROM)', time: '16:30',
        home: 'FCSB', away: 'Metaloglobus',
        market: 'Resultado', pick: 'Vitória Casa',
        confidencePct: '89.0', confidenceLevel: 'ALTA CONFIANÇA', levelClass: 'high',
        rating: 'Forte', statusGroup: 'upcoming',
        bestPick: 'home', bestPickLabel: 'Vitória Casa', edge: 6, probAdjusted: 65, probImplied: 59,
        explanation: 'FCSB com edge de +6% sobre adversário tecnicamente inferior. Alta confiança sustentada por probabilidade ajustada expressivamente acima da implícita.',
        keyStats: [
          'Prob ajustada casa: 65% vs implícita: 59%',
          'FCSB: ampla superioridade técnica e histórica',
          'Edge: +6% — aposta de alta confiança',
        ],
        iaFree: false,
      },
    ];
